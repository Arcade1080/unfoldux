...
export default function Services() {
  return (
    <Page title="Services">
      <p className="copy mb-4"> Zu meinen Kernleistungen zählen: </p>
      ...
      <div className="section">
        ...
        <ul className="copy list-disc pl-5">
          ...
          <li>Durchführung von Schulungen und Workshops </li>
        </ul>
      </div>
      ...
      <div className="section">
        ...
        <ul className="copy list-disc pl-5">
          ...
          <li>Entwicklung einer Product Vision</li>
      ...
      <div className="section">
        ...
        <ul className="copy list-disc pl-5">
          <li>Frontend Entwicklung mit HTML, CSS, JavaScript</li>
          <li>Verprobung von Hypothesen mit Prototyping</li>
          <li>Implementierung von Tracking- und Testkonzepten</li>
          <li>
            Erstellung von Komponentenbibliotheken im Kontext von Design
            Systemen{' '}
          </li>
      ...
      <div className="section">
        ...
        <ul className="copy list-disc pl-5">
          <li>Webanalytics</li>
          <li>Konzeption, Durchführung und Auswertung von A/B Tests</li>
          <li>Implementierung von Trackingkonzepten</li>
          <li>Erstellung und Optimierung von Landing Pages</li>
        </ul>
      </div>
    </Page>
  );
